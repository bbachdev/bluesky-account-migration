    ...
    <div className={`flex flex-col items-center justify-center h-full space-y-8`}>
      <div className={`border-2 border-red-500 bg-red-400/20 rounded-lg p-4 text-center w-1/3`}>
        <p className={`text-left text-md flex flex-col`}>
          ...
          <span>
            Using this Bluesky Account Migration Assistant may result in irreversible changes to your account. Please review the following information carefully before proceeding. By continuing with this application, you acknowledge and accept the potential consequences, which may include but are not limited to loss of data, modification of account settings, or the "locking out" of your account. It's strongly recommended to have an understanding of the migration process itself (<a className={`text-blue-500`} href="https://github.com/bluesky-social/pds/blob/main/ACCOUNT_MIGRATION.md" target="_blank" rel="noreferrer">https://github.com/bluesky-social/pds/blob/main/ACCOUNT_MIGRATION.md</a>) before proceeding.
